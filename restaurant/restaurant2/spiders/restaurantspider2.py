import scrapy
from restaurant2.items import Restaurant2Item
from urlparse import urljoin
from time import sleep

class restaurant2spider (scrapy.Spider):
	name = 'restaurant2spider'
	allowed_domains = ["yelp.com"]
	url_base1 = "http://www.yelp.com/search?find_desc=Restaurants&find_loc=New+York%2C+NY&ns=1&start="
	page_index = 0
	start_urls = []
